    ...
    public partial class InitialCreateV2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KitchenStations", x => x.StationId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PerformanceReports_Reports_ReportId",
                        column: x => x.ReportId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfitLossReports", x => x.ReportId);
                    table.ForeignKey(
                        name: "FK_ProfitLossReports_Reports_ReportId",
                        column: x => x.ReportId,
                        principalTable: "Reports",
                        principalColumn: "ReportId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesReports_Reports_ReportId",
                        column: x => x.ReportId,
                        principalTable: "Reports",
                        principalColumn: "ReportId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestPayment = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_POSSessions", x => x.SessionId);
                    table.ForeignKey(
                        name: "FK_POSSessions_Terminals_TerminalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BOMs_InventoryItems_InventoryItemId",
                        column: x => x.InventoryItemId,
                        principalTable: "InventoryItems",
                        principalColumn: "InventoryItemId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BOMs_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KOTs_KitchenStations_StationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OperationalAlerts", x => x.AlertId);
                    table.ForeignKey(
                        name: "FK_OperationalAlerts_Checklists_ChecklistId",
                        column: x => x.ChecklistId,
                        principalTable: "Checklists",
                        principalColumn: "ChecklistId",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_OperationalAlerts_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BOMs_InventoryItemId",
                table: "BOMs",
                column: "InventoryItemId");

            migrationBuilder.CreateIndex(
                name: "IX_BOMs_RecipeId",
                table: "BOMs",
                column: "RecipeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OperationalAlerts_ChecklistId",
                table: "OperationalAlerts",
                column: "ChecklistId");

            migrationBuilder.CreateIndex(
                name: "IX_OperationalAlerts_OrderId",
                table: "OperationalAlerts",
                column: "OrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_POSSessions_TerminalId",
                table: "POSSessions",
                column: "TerminalId");
